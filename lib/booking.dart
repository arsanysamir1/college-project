...
class activityBooking extends StatefulWidget {
  const activityBooking({Key? key}) : super(key: key);

  @override
  State<activityBooking> createState() => _bookingState();
}

class _bookingState extends State<activityBooking> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    final activityindex = ModalRoute.of(context)?.settings.arguments as activityIndex;
    myActivity.forEach((key, value) {
      if (value.id == activityindex.Id) {
        activity1 = value;
      }
    });
    return Scaffold(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(activity1.price, style: TextStyle(fontSize: 20)),
                    ],
                  ),
                ],
              ),
